...
<section class="banner-section bg_img" data-background="images/banner-bg.png" style="background-image: url(images/banner-bg.png);">
        <div class="container">
        ...
        <div class="banner-shape d-none d-lg-block">
            <img src="images/banner-shape.png" alt="css">
        </div>
    </section>
