                ...
                <div class="section-header-3" data-aos="zoom-out-down" data-aos-duration="1200">
                    <div class="left">
                        ...
                        <div class="title-area">
                            ...
                            <p>We offer affordable Art</p>
                        </div>
                    </div>
                    <a href="./auction.php" class="normal-button">View All</a>
                </div>
                <div class="row justify-content-center mb-30-none">
                    <div class="col-sm-10 col-md-6 col-lg-4">
                        <div class="auction-item-2" data-aos="zoom-out-up" data-aos-duration="2200">
                            <div class="auction-thumb">
                                <a href="./details.php"><img src="./assets/images/art1.png" alt="car"></a>
                                <a href="#0" class="rating"><i class="far fa-star"></i></a>
                                <a href="#0" class="bid"><img src="./assets/images/bid_logo.png"></a>
                            </div>
                            <div class="auction-content">
                                <h6 class="title">
                                    <a href="./details.php">Mona Lisa</a>
                                </h6>
                                <div class="bid-area">
                    ...
                    <div class="col-sm-10 col-md-6 col-lg-4">
                        <div class="auction-item-2" data-aos="zoom-out-up" data-aos-duration="1100">
                            <div class="auction-thumb">
                                <a href="./details.php"><img src="./assets/images/art2.png" alt="car"></a>
                                <a href="#0" class="rating"><i class="far fa-star"></i></a>
                                <a href="#0" class="bid"><img src="./assets/images/bid_logo.png"></a>
                            </div>
                            <div class="auction-content">
                                <h6 class="title">
                                    <a href="./details.php"> Lady With Daisies </a>
                                </h6>
                                <div class="bid-area">
                                    <div class="bid-amount">
                                        <div class="icon">
                    ...
                    <div class="col-sm-10 col-md-6 col-lg-4">
                        <div class="auction-item-2" data-aos="zoom-out-up" data-aos-duration="1200">
                            <div class="auction-thumb">
                                <a href="./details.php"><img src="./assets/images/art3.png" alt="car"></a>
                                <a href="#0" class="rating"><i class="far fa-star"></i></a>
                                <a href="#0" class="bid"><img src="./assets/images/bid_logo.png"></a>
                            </div>
                            <div class="auction-content">
                                <h6 class="title">
                                    <a href="./details.php">Woman Running Through Fairytale</a>
                                </h6>
                                <div class="bid-area">
                                    <div class="bid-amount">
                                        <div class="icon">
                ...
                <div class="row justify-content-center mb-30-none">
                    <div class="col-lg-6">
                        <div class="auction-item-3" data-aos="zoom-out-up" data-aos-duration="1500">
                            <div class="auction-thumb">
                                <a href="./product-details.html"><img src="./assets/images/art4.png" alt="popular"></a>
                                <a href="#0" class="bid"><i class="flaticon-auction"></i></a>
                            </div>
                            <div class="auction-content">
                                <h6 class="title">
                                    <a href="./product-details.html">Hans Zatzka - Mail from Across the Pond</a>
                                </h6>
                                <div class="bid-amount">
                                    <div class="icon">
                                        <i class="flaticon-auction"></i>
