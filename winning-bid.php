                    ...
                    <div class="dashboard-widget mb-30 mb-lg-0 sticky-menu">
                        <div class="user">
                            ...
                            <div class="content">
                                ...
                                <span class="username"><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="157f7a7d7b557278747c793b767a78">[email&#160;protected]</a></span>
                            </div>
                        </div>
                        <ul class="dashboard-menu">
                            ...
                            <li>
                                <a href="winning-bid.php" class="active"><i class="flaticon-best-seller"></i>Winning Bids</a>
                            </li>
                            <li>
                ...
                <div class="col-lg-8">
                    ...
                    <div class="row mb-30-none justify-content-center">
                        <div class="col-sm-10 col-md-6">
                            <div class="auction-item-2" data-aos="zoom-out-up" data-aos-duration="1000">
                                <div class="auction-thumb">
                                    <a href="./product-details.html"><img src="./assets/images/art2.png" alt="car"></a>
                        ...
                        <div class="col-sm-10 col-md-6">
                            <div class="auction-item-2" data-aos="zoom-out-up" data-aos-duration="1000">
                                <div class="auction-thumb">
                                    <a href="./product-details.html"><img src="./assets/images/art2.png" alt="product"></a>
                                    <a href="#0" class="rating"><i class="far fa-star"></i></a>
                                    <a href="#0" class="bid"><i class="flaticon-auction"></i></a>
                                </div>
                                <div class="auction-content">
