                        ...
                        <div class="product-bid-area">
                            <form class="product-bid-form">
                                <div class="search-icon">
                                    <img src="./assets/images/search-icon.png" alt="product">
                                </div>
                        ...
                        <div class="product-single-sidebar mb-3">
                            ...
                            <div class="side-counter-area">
                                <div class="side-counter-item">
                                    <div class="thumb">
                                        <img src="./assets/images/icon1.png" alt="product">
                                    </div>
                                    <div class="content">
                                ...
                                <div class="side-counter-item">
                                    <div class="thumb">
                                        <img src="./assets/images/icon2.png" alt="product">
                                    </div>
                                    <div class="content">
                                ...
                                <div class="side-counter-item">
                                    <div class="thumb">
                                        <img src="./assets/images/icon3.png" alt="product">
                                    </div>
                                    <div class="content">
                ...
                <ul class="product-tab-menu nav nav-tabs">
                    <li>
                        <a href="#details" class="active" data-toggle="tab">
                            <div class="thumb">
                                <img src="./assets/images/tab1.png" alt="product">
                            </div>
                    ...
                    <li>
                        <a href="#delevery" data-toggle="tab">
                            <div class="thumb">
                                <img src="./assets/images/tab2.png" alt="product">
                            </div>
                    ...
                    <li>
                        <a href="#history" data-toggle="tab">
                            <div class="thumb">
                                <img src="./assets/images/tab3.png" alt="product">
                            </div>
                    ...
                    <li>
                        <a href="#questions" data-toggle="tab">
                            <div class="thumb">
                                <img src="./assets/images/tab4.png" alt="product">
                            </div>
